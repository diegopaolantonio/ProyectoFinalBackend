...
router.get("/tickets", checkSession, getTicketByPurchaser); // Llamado a la vista de tickets
router.get("/tickets/:tid", checkSession, getTicketById);
